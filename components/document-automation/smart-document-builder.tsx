...
export function SmartDocumentBuilder() {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>Smart Document Builder</CardTitle>
        <CardDescription>Generate legally compliant documents tailored to your needs</CardDescription>
      </CardHeader>
      <CardContent>
        <Form {...form}>
